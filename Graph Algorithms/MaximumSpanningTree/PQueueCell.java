...
public Cell deleteMax()
{
   Cell max_el = new Cell();
   Cell tmp = new Cell();
   max_el.setKey(heap[1].getKey());              
   max_el.setItem(heap[1].getItem());           
   
   tmp.setKey(heap[currentSize].getKey());     
   tmp.setItem(heap[currentSize].getItem());   
